...
import { startIngestRetryWorker } from './ingestRetry.js';
...
export async function startSourcedocsJobs(app: FastifyInstance): Promise<void> {
  ...
  // B-I4: a committed source version whose ingest threw is retried here rather than being
  // reported as a failed save.
  await startIngestRetryWorker(app);
}

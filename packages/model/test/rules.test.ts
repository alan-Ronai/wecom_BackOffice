...
const ctx: ProposalContext = {
  ...
  diffs: [
    {
      ref: '4.8',
      kind: 'changed',
      before: 'בקש מהלקוח להריץ Speedtest. מעל 5 מגה – תקין.',
      after: 'בקש מהלקוח להריץ Speedtest. מעל 6 מגה – תקין. יש לוודא שהלקוח מנותק מ-Wi-Fi לפני הבדיקה.',
      similarity: 0.8,
    },
    {
      ref: '4.14',
      ...
      before: null,
      after:
        'בעיות גלישה ברכב. אם הלקוח מדווח על איטיות רק ברכב – בדוק Wi-Fi של הרכב. הנחה לכבות Wi-Fi ברכב.',
      similarity: 0,
    },
    {
      ref: '4.11',
      kind: 'changed',
      before: 'ריענון SIM. sim block lbl ← שמור.',
      after: 'ריענון SIM. sim block lbl ← שמור. ולחכות 90 שניות.',
      similarity: 0.9,
    },
  ],
  linkedSteps: [
  ...
  blocks: [
    { id: 'blk-1', title: 'ריענון SIM', actions: ['CRM ← sim block lbl ← שמור', 'בקש מהלקוח לאתחל מכשיר'] },
  ],
};
...
describe('RuleBasedModel', () => {
  ...
  it('is always available', async () => {
    expect(await new RuleBasedModel().available()).toBe(true);
  });
});
